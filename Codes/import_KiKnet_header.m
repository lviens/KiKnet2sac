function header = import_KiKnet_header(filename, startRow, endRow)
%IMPORTFILE Import numeric data from a text file as a matrix.
%   TKY0071103111446 = IMPORTFILE(FILENAME) Reads data from text file
%   FILENAME for the default selection.
%
%   TKY0071103111446 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data
%   from rows STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   TKY0071103111446 = importfile('TKY0071103111446.EW', 1, 16);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/05/19 13:42:52
